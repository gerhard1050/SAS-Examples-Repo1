...
proc sql ;
 ...
 create table work.Prom_Data_Aggr
 as select id,
 ...
 create table work.Target_Data_Aggr
 as select id,
 ...
 create table work.bigorganics_assmbl
 as select d.id,
           d.DemAffl,
           d.DemAge,
           d.DemCluster,
           ...
           case 
             ...
             as TargetBuy label="Organics Purchase Indicator",
           case 
             when t.TargetAmt =. then 0
             else t.TargetAmt
             end
             as TargetAmt label="Organics Purchase Count"
 from 
work.BORG_DEMOGR as d
 ...
 *** Apply Lookup Tables;
label 
DemClusterGroup ="Neighborhood Cluster-7 Level"
 ...
 *** Spend Data;
label 
PromClass ="Loyalty Status"
PromSpend ="Total Spend"
PromTime = "Loyalty Card Tenure"
;
...
TargetAmt = "Organics Purchase Amount"
;
